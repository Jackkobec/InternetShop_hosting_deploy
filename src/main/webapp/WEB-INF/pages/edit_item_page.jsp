                                ...
                                <p><h4><fmt:message key="cart_is_empty" bundle="${rb}"/></h4><p>
                                    ...
                                    <tr>
                                        ...
                                        <form action="Controller" method="POST">
                                            ...
                                            <input type="hidden" name="item_for_edit_id" value="${itemForEdit.id}">
                                            <input type="hidden" name="itemEditMode" value="${itemEditMode}">
                                            <input type="hidden" name="from_page" value="EDIT_ITEM_PAGE">
...
<%--GLOBAL BLOCK. EDIT ITEM. ADD OR UPDATE--%>
<%--Item--%>
